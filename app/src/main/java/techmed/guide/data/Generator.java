...
public class Generator {
    ...
    public static final List<Examen> listExamensCoeur(){
        ...
        items.add(new Examen("Echographie-Doppler des artères", R.drawable.echo_dopler_artères, "Visualiser les tissus et la cinétique", "L'écho-Doppler artériel permet de visualiser les artères et les flux sanguins qui les parcourent, en temps réel.C'est l'examen complémentaire de référence pratiqué dans le bilan des artérites des membres inférieurs et dans leur suivi.\n" +
        ...
        items.add(new Examen("Echographie transoesophagienne", R.drawable.echo_transoeuso, "Visualiser parfaitement l’ensemble des tissus qui constituent le cœur", "Cet examen spécialisé, explore le cœur,\n" +
